...
//   out = env->GetStringUTFChars(video_out, 0);
	...
	VideoCapture capture_5(in_1);
	VideoCapture capture_6(in_2);
...
//	env->ReleaseStringUTFChars(video_out, out);
	...
	Mat frame, frame_U, frame1, frame2, frame3, frame_1, frame_2, frame_3, frame_4, frame_5, frame_6;
    int count = 0;
	capture_1 >> frame_1;
	capture_2 >> frame_2;
	capture_3 >> frame_3;
	...
	int dWidth = capture_1.get(CV_CAP_PROP_FRAME_WIDTH)*3; //get the width of frames of the video
...
//		combineTwoImages(frame,frame_1,frame_2);
        ...
        vconcat(frame1,frame2,frame_U);

        vconcat(frame_5,frame_6,frame3);
        hconcat(frame3,frame_U,frame);
